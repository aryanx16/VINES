                    ...
                    <div className="flex items-center flex-col">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex flex-col gap-5 mt-5">
                                ...
                                <input onChange={(e) => { setPhone(e.target.value) }} className="bg-secondary border-bordcol border shadow-2xl p-1 w-80 sm:w-[500px] rounded-md " type="text" placeholder="Phone No." />
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <label htmlFor="fileh" className="bg-neutral-100  text-black h-fit font-semibold shadow-2xl rounded-md p-1 w-44 cursor-pointer hover:bg-slate-200 sm:w-40 ">Select Channel Logo</label>
